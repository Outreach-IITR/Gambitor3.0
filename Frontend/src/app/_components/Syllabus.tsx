...
function NavButton({text}:any){
    return (
           ...
           <button  className="border border-slate-300 rounded p-3 bg-grey w-[15vw] text-base text-white font-semibold">{text}</button>
...
export default function Syllabus(){
    ...
    return(
        <section className="text-white relative z-[1]  mx-[15vw] pt-[10vh] flex flex-col text-center space-y-10" id="SYLLABUS">
            <h1 className ="text-4xl my-[5vh] font-bold" >SYLLABUS</h1>
            <div>
            ...
            {std === 'CLASS 9' && (
        <div className="mt-4 px-[15vw] pt-[5vh] text-white text-2xl rounded ">
