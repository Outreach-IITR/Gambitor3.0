...
export default function Categories() {
    ...
    return (
        <div id='CATEGORIES' className="relative bg-[#2445B5] z-[4]  h-[1052px] w-full text-white">
            {/* <Navbar></Navbar> */}
            <div>
                <h1 className="font-cooper w-full absolute text-[32px] text-center top-[100px]  text-white font-normal leading-[36.7px] " style={{fontFamily:'Cooper Black'}}>CATEGORIES</h1>
